...
| `yellowback_fed.py`, `test_yellowback_fed.py`, `yellowback-redeem` | The retired federation coordinator and its tests; retired by the Phase 0 / Phase 7 cleanup, kept until CI is repointed | retired |

...
| `yed_estimatecollateral` | `cents tier [priceMicroUsd]` | `cents`, `tier`, `ratioPct`, `lockBlocks`, `evalHeight`, `dcaBps`, `priceMicroUsd`, `requiredZat`, `required`, `lockHeight`, `expiryHeight`; or `error: bad-oracle-price` |

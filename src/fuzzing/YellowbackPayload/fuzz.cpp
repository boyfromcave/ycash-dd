...
// Fuzz target for the Yellowback payload decoder (plan C14, §6 Phase 6).
// Same layout as the other targets under src/fuzzing/: an AFL main reading a
// file, and a libFuzzer entry point. The decoder must never throw or read out
// of bounds; a malformed payload is simply "not Yellowback".

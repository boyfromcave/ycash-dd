 ...
 * of the chain (V17, mapping.md §13).
 *
 * Functions marked "v1, retained" are the federation prototype's (DCA/ERR
 * tables, ref/digibyte/src/consensus/dca.cpp:53-58, err.cpp:38-41,100); they
 * stay until state.cpp/txbuilder.cpp migrate (Phase 2) and are then deleted.
 */
...
// ---------------------------------------------------------------- v1, retained (deleted in Phase 2)

/**
 * v1, retained. System health in percent, capped at HEALTH_CAP:
